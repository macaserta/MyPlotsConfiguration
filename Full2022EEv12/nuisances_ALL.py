...
nuisances['WWnorm0j']  = {
               'name'  : 'CMS_ww_WWnorm0j_2022EE',
               'samples'  : {'WW' : '1.00' },
               'type'  : 'rateParam',
               'cuts'  : cuts0j_SR
              }
nuisances['WWnorm1j']  = {
               'name'  : 'CMS_ww_WWnorm1j_2022EE',
               'samples'  : {'WW' : '1.00'},
               'type'  : 'rateParam',
               'cuts'  : cuts1j_SR
        }
nuisances['WWnorm2j']  = {
                'name'  : 'CMS_ww_WWnorm2j_2022EE',
                'samples'  : {'WW' : '1.00'},
                'type'  : 'rateParam',
                'cuts': cuts2j_SR
              }
