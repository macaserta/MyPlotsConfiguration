...
variables['nbjet']  = {
    'name': 'Sum(CleanJet_pt > 30. && abs(CleanJet_eta) < 2.5 && Take(Jet_btagRobustParTAK4B, CleanJet_jetIdx) > 0.0681)',
    'range' : (5,0,5),
...
variables['nbjet_20']  = {
    'name': 'Sum(CleanJet_pt > 20. && abs(CleanJet_eta) < 2.5 && Take(Jet_btagRobustParTAK4B, CleanJet_jetIdx) > 0.0681)',
    'range' : (5,0,5),
    'xaxis' : 'Number of b-jets (20 GeV)',
    'fold' : 2
}
