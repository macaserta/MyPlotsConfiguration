...
def run(submit=False, onlySample=None):
    ...
    path = prePath + "mkShapesRDF/FullRun3/WW2022_Paper_PROVA/condor/EGamma_Run2022D-ReReco-v1/"
    output_path = "/eos/user/m/mcaserta/mkShapesRDF_rootfiles/Run3_WW/Run3_WW_2023_nuisancesALL_PROVA/rootFile/"
    jobDir = path
    ...
    fnames = [fname.decode('ascii').split("EGamma_Run2022D-ReReco-v1/")[1] for fname in fnames]
    ...
    for fname in fnames:
        ...
        file_name = output_path + "/mkShapes__Run3_WW_2023_nuisancesALL_PROVA__ALL__" + fname + ".root"
