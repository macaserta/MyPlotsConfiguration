...
aliases['fakeW'] = {
    'linesToAdd' : ['#include "/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/extended/fake_rate_reader_class.cc"'],
...
aliases['KFactor_ggWW_NLO'] = {
    'linesToProcess':[
        'ROOT.gSystem.Load("/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/extended/ggww_kfactor_cc.so","", ROOT.kTRUE)',
...
aliases['wwNLL'] = {
    'linesToProcess':[
        'ROOT.gSystem.Load("/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/extended/qqww_kfactor_cc.so","", ROOT.kTRUE)',
        """ROOT.gInterpreter.Declare('qqww_K_producer k_reader_QQWW = qqww_K_producer("/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/extended/wwresum/central.dat","/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/extended/wwresum/resum_up.dat", "/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/extended/wwresum/resum_down.dat","/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/extended/wwresum/scale_up.dat","/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/extended/wwresum/scale_down.dat");')"""
    ],
...
aliases['Weight2MINLO'] = {
    'linesToProcess': ['ROOT.gSystem.Load("/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/extended/weight2MINLO_cc.so")'],
    'class': 'Weight2MINLO',
...
aliases['noJetInHorn'] = {
    'linesToAdd' : ['#include "/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/extended/jet_horns.cc"'],
...
year = '2023_Summer23' 
btv_path =  '/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/mkShapesRDF/jsonpog-integration/POG/BTV/' + year
...
for flavour in ['bc', 'light']:
    ...
    aliases[btagsf_tmp] = {
        'linesToProcess':[
            f'ROOT.gSystem.Load("/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/extended/evaluate_btagSF{flavour}_cc.so","", ROOT.kTRUE)',
            f"ROOT.gInterpreter.Declare('btagSF{flavour} btag_SF{flavour} = btagSF{flavour}(\"/afs/cern.ch/user/m/mcaserta/private/Production/mkShapesRDF/MyPlotsConfiguration/data/btag_eff/bTagEff_2023_ttbar_loose.root\",\"{year}\",\"_parT\");')"
        ],
